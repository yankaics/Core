    ...
    after(:create) do |ntust|
      ...
      Department.import(columns,
        [
          ...
          ["NTUST", "D35", "應用科技研究所", "應用科技研究所", "C06", 'D'],
          ["NTUST", "D36", "應用科技學士學位學程", "應用科技學程", "C06", 'D'],
          ["NTUST", "D37", "人文社會學科", "人文社會學科", "C05", 'D'],
          ["NTUST", "D38", "智慧財產學士學位學程", "智慧財產學程", "C07", 'D'],
          ["NTUST", "D39", "科技管理學士學位學程", "科技管理學程", "C07", 'D'],
          ["NTUST", "D40", "色彩與照明科技研究所", "色彩所", "C06", 'D']
