    ...
    after(:create) do |ttu|
      ...
      Department.import(columns,
        [
          ...
          ["TTU", "K", "設計科學研究所", "設科所", nil, 'D'],
          ["TTU", "KM", "設計科學研究所博士班", "設科所博班", "K", 'DC'],

          ["TTU", "E",   "電機工程學系", "電機系所", nil, 'D'],
