    ...
    after(:create) do |nthu|
      ...
      Department.import(columns,
        [
          ...
          ["NTHU", "0015", "先進光源科技學位學程物理組碩士班", "先進光源科技學位學程", "001", 'MC'],
          ["NTHU", "0016", "先進光源科技學位學程工科組碩士班", "先進光源科技學位學程", "001", 'MC'],
          ["NTHU", "0018", "先進光源科技學位學程博士班", "先進光源科技學位學程", "001", 'DC'],
          ["NTHU", "0025", "學習科學研究所碩士班", "學習科學研究所", "002", 'MC'],
          ["NTHU", "0100", "原科院學士班", "原科院學士班", "010", 'BC'],
          ["NTHU", "0111", "工程與系統科學系清班", "工程與系統科學系", "011", 'BC'],
          ["NTHU", "0112", "工程與系統科學系華班", "工程與系統科學系", "011", 'BC'],
          ["NTHU", "0115", "工程與系統科學系碩士班", "工程與系統科學系", "011", 'MC'],
          ["NTHU", "0118", "工程與系統科學系博士班", "工程與系統科學系", "011", 'DC'],
          ["NTHU", "0120", "生醫工程與環境科學系學士班", "生醫工程與環境科學系", "012", 'BC'],
          ["NTHU", "0125", "生醫工程與環境科學系碩士班", "生醫工程與環境科學系", "012", 'MC'],
          ["NTHU", "0128", "生醫工程與環境科學系博士班", "生醫工程與環境科學系", "012", 'DC'],
          ["NTHU", "0135", "核子工程與科學研究所碩士班", "核子工程與科學研究所", "013", 'MC'],
          ["NTHU", "0138", "核子工程與科學研究所博士班", "核子工程與科學研究所", "013", 'DC'],
          ["NTHU", "0200", "理學院學士班", "理學院學士班", "020", 'BC'],
          ["NTHU", "0208", "理學院博士班", "理學院博士班", "020", 'DC'],
          ["NTHU", "0212", "數學系純粹數學組學士班", "數學系純粹數學組", "021", 'BC'],
          ["NTHU", "0211", "數學系應用數學組學士班", "數學系應用數學組", "021", 'BC'],
          ["NTHU", "0215", "數學系純粹數學組碩士班", "數學系純粹數學組", "021", 'MC'],
          ["NTHU", "0216", "數學系應用數學組碩士班", "數學系應用數學組", "021", 'MC'],
          ["NTHU", "0218", "數學系博士班", "數學系博士班", "021", 'DC'],
          ["NTHU", "0221", "物理學系物理組學士班", "物理學系物理組", "022", 'BC'],
          ["NTHU", "0222", "物理學系光電物理組學士班", "物理學系光電物理組", "022", 'BC'],
          ["NTHU", "0225", "物理學系碩士班", "物理學系", "022", 'MC'],
          ["NTHU", "0228", "物理學系博士班", "物理學系", "022", 'DC'],
          ["NTHU", "0230", "化學系學士班", "化學系", "023", 'BC'],
          ["NTHU", "0235", "化學系化學組碩士班", "化學系化學組", "023", 'MC'],
          ["NTHU", "0236", "化學系應用化學組碩士班", "化學系應用化學組", "023", 'MC'],
          ["NTHU", "0238", "化學系博士班", "化學系", "023", 'DC'],
          ["NTHU", "0245", "統計學研究所碩士班", "統計學研究所", "024", 'MC'],
          ["NTHU", "0248", "統計學研究所博士班", "統計學研究所", "024", 'DC'],
          ["NTHU", "0255", "天文研究所碩士班", "天文研究所", "025", 'MC'],
          ["NTHU", "0258", "天文研究所博士班", "天文研究所", "025", 'DC'],
          ["NTHU", "0300", "工學院學士班", "工學院學士班", "030", 'BC'],
          ["NTHU", "0305", "工學院生物工程學程碩士班", "工學院生物工程學程", "030", 'MC'],
          ["NTHU", "0306", "工學院分子工程學程碩士班", "工學院分子工程學程", "030", 'MC'],
          ["NTHU", "0311", "材料科學工程學系學士清班", "材料科學工程學系清班", "031", 'BC'],
          ["NTHU", "0312", "材料科學工程學系學士華班", "材料科學工程學系華班", "031", 'BC'],
          ["NTHU", "0315", "材料科學工程學系碩士班", "材料科學工程學系", "031", 'MC'],
          ["NTHU", "0316", "材料科學工程學系碩士班", "材料科學工程學系", "031", 'MC'],
          ["NTHU", "0318", "材料科學工程學系博士班", "材料科學工程學系", "031", 'DC'],
          ["NTHU", "0320", "化學工程學系學士班", "化學工程學系", "032", 'BC'],
          ["NTHU", "0325", "化學工程學系碩士班", "化學工程學系", "032", 'MC'],
          ["NTHU", "0328", "化學工程學系博士班", "化學工程學系", "032", 'DC'],
          ["NTHU", "0331", "動力機械工程學系學士清班", "動力機械工程學系清班", "033", 'BC'],
          ["NTHU", "0332", "動力機械工程學系學士華班", "動力機械工程學系華班", "033", 'BC'],
          ["NTHU", "0335", "動力機械工程學系碩士班", "動力機械工程學系", "033", 'MC'],
          ["NTHU", "0336", "動力機械工程學系碩士班", "動力機械工程學系", "033", 'MC'],
          ["NTHU", "0338", "動力機械工程學系博士班", "動力機械工程學系", "033", 'DC'],
          ["NTHU", "0340", "工業工程與工程管理學系學士班", "工業工程與工程管理學系", "034", 'BC'],
          ["NTHU", "0345", "工業工程與工程管理學系工業工程組碩士班", "工業工程與工程管理學系工業工程組", "034", 'MC'],
          ["NTHU", "0346", "工業工程與工程管理學系工程管理組碩士班", "工業工程與工程管理學系工程管理組", "034", 'MC'],
          ["NTHU", "0348", "工業工程與工程管理學系博士班", "工業工程與工程管理學系", "034", 'DC'],
          ["NTHU", "0355", "奈米工程與微系統研究所碩士班", "奈米工程與微系統研究所", "035", 'MC'],
          ["NTHU", "0358", "奈米工程與微系統研究所博士班", "奈米工程與微系統研究所", "035", 'DC'],
          ...
          ["NTHU", "0410", "中國文學系學士班", "中國文學系", "041", 'BC'],
          ["NTHU", "0415", "中國文學系碩士班", "中國文學系", "041", 'MC'],
          ["NTHU", "0418", "中國文學系博士班", "中國文學系", "041", 'DC'],
          ["NTHU", "0420", "外國語文學系學士班", "外國語文學系", "042", 'BC'],
          ["NTHU", "0425", "外國語文學系碩士班", "外國語文學系", "042", 'MC'],
          ["NTHU", "0426", "外國語文學系外語教學組碩士班", "外國語文學系外語教學組", "042", 'MC'],
          ["NTHU", "0435", "歷史研究所碩士班", "歷史研究所", "043", 'MC'],
          ["NTHU", "0438", "歷史研究所博士班", "歷史研究所", "043", 'DC'],
          ["NTHU", "0436", "歷史研究所中研院合作學程碩士班", "歷史研究所中研院合作學程", "043", 'MC'],
          ["NTHU", "0445", "語言學研究所碩士班", "語言學研究所", "044", 'MC'],
          ["NTHU", "0448", "語言學研究所博士班", "語言學研究所", "044", 'DC'],
          ["NTHU", "0455", "社會學研究所碩士班", "社會學研究所", "045", 'MC'],
          ["NTHU", "0458", "社會學研究所博士班", "社會學研究所", "045", 'DC'],
          ["NTHU", "0456", "社會學研究所中研院合作學程碩士班", "社會學研究所中研院合作學程", "045", 'MC'],
          ["NTHU", "0465", "人類學研究所碩士班", "人類學研究所", "046", 'MC'],
          ["NTHU", "0468", "人類學研究所博士班", "人類學研究所", "046", 'DC'],
          ["NTHU", "0475", "哲學研究所碩士班", "哲學研究所", "047", 'MC'],
          ["NTHU", "0481", "人文社會學院學士清班", "人文社會學院清班", "048", 'BC'],
          ["NTHU", "0482", "人文社會學院學士華班", "人文社會學院華班", "048", 'BC'],
          ["NTHU", "0495", "台灣文學研究所碩士班", "台灣文學研究所", "049", 'MC'],
          ["NTHU", "0498", "台灣文學研究所博士班", "台灣文學研究所", "049", 'DC'],
          ["NTHU", "1415", "台灣教師在職進修專班", "台灣教師在職進修專班", "141", 'MC'],
          ["NTHU", "1425", "亞際文化研究碩士學位國際學程", "亞際文化研究碩士學位國際學程", "142", 'MC'],
          ["NTHU", "0600", "電機資訊學院學士班", "電機資訊學院", "060", 'BC'],
          ["NTHU", "0611", "電機工程學系學士清班", "電機工程學系清班", "061", 'BC'],
          ["NTHU", "0612", "電機工程學系學士華班", "電機工程學系華班", "061", 'BC'],
          ["NTHU", "0615", "電機工程學系碩士班", "電機工程學系", "061", 'MC'],
          ["NTHU", "0616", "電機工程學系碩士班", "電機工程學系", "061", 'MC'],
          ["NTHU", "0618", "電機工程學系博士班", "電機工程學系", "061", 'DC'],
          ["NTHU", "0621", "資訊工程學系學士清班", "資訊工程學系清班", "062", 'BC'],
          ["NTHU", "0622", "資訊工程學系學士華班", "資訊工程學系華班", "062", 'BC'],
          ["NTHU", "0623", "資訊工程學系學士梅班", "資訊工程學系梅班", "062", 'BC'],
          ["NTHU", "0625", "資訊工程學系碩士班", "資訊工程學系", "062", 'MC'],
          ["NTHU", "0626", "資訊工程學系碩士班", "資訊工程學系", "062", 'MC'],
          ["NTHU", "0628", "資訊工程學系博士班", "資訊工程學系", "062", 'DC'],
          ["NTHU", "0635", "電子工程研究所碩士班", "電子工程研究所", "063", 'MC'],
          ["NTHU", "0638", "電子工程研究所博士班", "電子工程研究所", "063", 'DC'],
          ["NTHU", "0645", "通訊工程研究所碩士班", "通訊工程研究所", "064", 'MC'],
          ["NTHU", "0648", "通訊工程研究所博士班", "通訊工程研究所", "064", 'DC'],
          ["NTHU", "0655", "資訊系統與應用研究所碩士班", "資訊系統與應用研究所", "065", 'MC'],
          ["NTHU", "0658", "資訊系統與應用研究所博士班", "資訊系統與應用研究所", "065", 'DC'],
          ["NTHU", "0656", "資訊系統與應用研究所碩士班", "資訊系統與應用研究所", "065", 'MC'],
          ["NTHU", "0665", "光電工程研究所碩士班", "光電工程研究所", "066", 'MC'],
          ["NTHU", "0668", "光電工程研究所博士班", "光電工程研究所", "066", 'DC'],
          ...
          ["NTHU", "0700", "科技管理學院學士班", "科技管理學院", "070", 'BC'],
          ["NTHU", "0710", "計量財務金融系學士班", "計量財務金融系", "071", 'BC'],
          ["NTHU", "0715", "計量財務金融系碩士班", "計量財務金融系", "071", 'MC'],
          ["NTHU", "0721", "經濟學系學士清班", "經濟學系清班", "072", 'BC'],
          ["NTHU", "0722", "經濟學系學士華班", "經濟學系華班", "072", 'BC'],
          ["NTHU", "0725", "經濟學系碩士班", "經濟學系", "072", 'MC'],
          ["NTHU", "0728", "經濟學系博士班", "經濟學系", "072", 'DC'],
          ["NTHU", "0735", "科技管理研究所碩士班", "科技管理研究所", "073", 'MC'],
          ["NTHU", "0738", "科技管理研究所博士班", "科技管理研究所", "073", 'DC'],
          ["NTHU", "0745", "科技法律研究所科技組碩士班", "科技法律研究所科技組", "074", 'MC'],
          ["NTHU", "0746", "科技法律研究所一般法律組碩士班", "科技法律研究所一般法律組", "074", 'MC'],
          ["NTHU", "0755", "高階經營管理碩士在職專班", "高階經營管理碩士在職專班", "075", 'MC'],
          ["NTHU", "0765", "經營管理碩士在職專班", "經營管理碩士在職專班", "076", 'MC'],
          ["NTHU", "0775", "國際專業管理碩士班", "國際專業管理碩士班", "077", 'MC'],
          ["NTHU", "0785", "服務科學研究所碩士班", "服務科學研究所", "078", 'MC'],
          ["NTHU", "0788", "服務科學研究所博士班", "服務科學研究所", "078", 'DC'],
          ["NTHU", "0800", "生命科學院學士班", "生命科學院", "080", 'BC'],
          ["NTHU", "0805", "生命科學院碩士班", "生命科學院", "080", 'MC'],
          ["NTHU", "0806", "生命科學院碩士班", "生命科學院", "080", 'MC'],
          ["NTHU", "0808", "生命科學院博士班", "生命科學院", "080", 'DC'],
          ["NTHU", "0810", "生命科學系學士班", "生命科學系", "081", 'BC'],
          ["NTHU", "0820", "醫學科學系學士班", "醫學科學系", "082", 'BC'],
