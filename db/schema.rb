...
ActiveRecord::Schema.define(version: 20160420124221) do
  ...
  create_table "chat_daily_questions", force: :cascade do |t|
    t.string   "question"
    t.datetime "send_at"
  ...
  create_table "user_manual_validations", force: :cascade do |t|
    t.integer  "user_id"
